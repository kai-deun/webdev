...
*/
import { prescriptionObject } from "./singletons.js";
        ...
        html += `
                    <div class="patient-card">
                        <div class="patient-info">
                            <div class="patient-name">${patient.first_name} ${
          patient.last_name
        }</div>
          ...
          patient.age
                            ...
                            <div class="patient-contact">
                                Phone: ${patient.phone || "N/A"} | Email: ${
          patient.email || "N/A"
        }
                            </div>
                        </div>
                        <div class="patient-actions">
                            <button class="btn btn-primary js-select-patient" data-patient-id="${
                              patient.patient_id
                            }">
                                <i class="fas fa-file-medical"></i> Medical History
                            </button>
                            <button class="btn btn-success js-new-prescription" data-patient-id="${
                              patient.patient_id
                            }">
  ...
  displayPrescriptions() {
    ...
    if (prescriptionObject.getPrescriptions().length === 0) {
      ...
      patients.forEach((patient, index) => {
        ...
        const perPatientPrescription = prescriptionObject
          .getPrescriptions()
          .filter((prescription) => {
        ...
        if (perPatientPrescription.length > 0) {
          ...
          perPatientPrescription.forEach((prescription, index) => {
            ...
            html += `
                                    <div class="prescription-card" data-prescription-id="${
