...
class PrescriptionManager {
    ...
    addMedicineToPrescription() {
        ...
        this.currentPrescription.medicines.push(medicineData);
    ...
    displayCurrentPrescription() {
        ...
        if (this.currentPrescription.medicines.length === 0) {
            ...
            html += '<ul>';
            this.currentPrescription.medicines.forEach((medicine, index) => {
                html += `
                    <li>
    ...
    async savePrescription() {
        ...
        const prescriptionData = {
            ...
            diagnosis: diagnosis,
            notes: notes,
            medicines: this.currentPrescription.medicines
        };
    ...
    clearPrescriptionForm() {
        ...
        this.currentPrescription.medicines = [];
        this.displayCurrentPrescription();
        this.clearMedicineForm();
    }
    ...
    filterPrescriptionsByStatus(status) {
        const filteredPrescriptions = status ? 
            this.prescriptions.filter(p => p.status.toLowerCase() === status.toLowerCase()) :
            this.prescriptions;
